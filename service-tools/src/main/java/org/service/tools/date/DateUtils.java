...
public class DateUtils {
	...
	*/
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(sf.format(getDateDayBefore(new Date() ,1)));
		*/
		/*System.out.println(DateUtils.calLastedTimes(new Date(),DateUtils.getDayAfter(1)));*/
		/*System.out.println(calLastedTimes(new Date(),getDateDayAfter(new Date(),1)));*/
		
		/*SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		System.out.println(sf.format(getDateDayAfter(new Date(),1)));*/
		
		/*SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd");
		Date parse = sf.parse("2018-11-29");
		System.out.println(sf.format(getDayAfter(1)));
		System.out.println(sf.format(getDayAfter(7)));
		
		System.out.println(isEffectiveDate(parse,getDayAfter(1),getDayAfter(7)));*/
		/*SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
