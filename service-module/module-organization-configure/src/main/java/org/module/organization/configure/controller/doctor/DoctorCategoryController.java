...
import org.module.organization.configure.service.doctor.DoctorCategoryService;
...
public class DoctorCategoryController {
	...
	*/
	@RequiresAuthentication( value = { "organization:configure:doctorCategory:list" },level=Level.OPERATION)
