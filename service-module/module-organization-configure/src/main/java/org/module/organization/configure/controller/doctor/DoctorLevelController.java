...
import org.module.organization.configure.service.doctor.DoctorLevelService;
...
public class DoctorLevelController {
	...
	*/
	@RequiresAuthentication( value = { "organization:configure:doctorLevel:insert" },level=Level.OPERATION)
	...
	*/
	@RequiresAuthentication(value = { "organization:configure:doctorLevel:update" },level=Level.OPERATION)
	...
	*/
	@RequiresAuthentication( value = { "organization:configure:doctorLevel:list" },level=Level.OPERATION)
