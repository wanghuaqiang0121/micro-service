 ...
 */
public class ItvDoctorSecurityInterceptor extends HandlerInterceptorAdapter {

	private static final Logger logger = LoggerFactory.getLogger(ItvDoctorSecurityInterceptor.class);
	@Resource
